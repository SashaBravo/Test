...
ATestCharacter::ATestCharacter()
{
	...
	Cap->SetCollisionProfileName("Overlap");
	Cap->OnComponentBeginOverlap.AddDynamic(this, &ATestCharacter::OnOverlapBegin);
}
...
void ATestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Punch", IE_Pressed,this, &ATestCharacter::Serv);
}

void ATestCharacter::BeginPlay()
{
	Super::BeginPlay();
	Cap->OnComponentEndOverlap.AddDynamic(this, &ATestCharacter::OnOverlapEnd);
}


void ATestCharacter::Serv_Implementation()
{
	Repli();
}

void ATestCharacter::Repli_Implementation()
{
	Punch();
}
